            ...
            writer.writerow(
                {
                    ...
                    "vitar_url": " | ".join(source["url"] for source in master["sources"] if source["source_key"] == "vitar"),
                    "nasevitaminy_url": " | ".join(source["url"] for source in master["sources"] if source["source_key"] == "nasevitaminy"),
                    "ceskevitaminy_url": " | ".join(source["url"] for source in master["sources"] if source["source_key"] == "ceskevitaminy"),
